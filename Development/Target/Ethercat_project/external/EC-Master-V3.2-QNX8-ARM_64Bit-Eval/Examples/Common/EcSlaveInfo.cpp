...
EC_T_BOOL PrintSlaveInfos(T_EC_DEMO_APP_CONTEXT* pAppContext)
{
    ...
    dwRes = emonGetBusSlaveInfo(pAppContext->dwInstanceId, EC_FALSE, wAutoIncAddress, &oBusSlaveInfo);
        ...
        {
            EcLogMsg(EC_LOG_LEVEL_INFO, (pEcLogContext, EC_LOG_LEVEL_INFO, "PD OUT 2 Byte.Bit Offset: %d.%d   Size: %d Bits, MSU %2d\n", oCfgSlaveInfo.dwPdOffsOut2 / 8, oCfgSlaveInfo.dwPdOffsOut2 % 8, oCfgSlaveInfo.dwPdSizeOut2, oCfgSlaveInfo.awMasterSyncUnitOut[1]));
        }
        ...
        {
            EcLogMsg(EC_LOG_LEVEL_INFO, (pEcLogContext, EC_LOG_LEVEL_INFO, "PD OUT 3 Byte.Bit Offset: %d.%d   Size: %d Bits, MSU %2d\n", oCfgSlaveInfo.dwPdOffsOut3 / 8, oCfgSlaveInfo.dwPdOffsOut3 % 8, oCfgSlaveInfo.dwPdSizeOut3, oCfgSlaveInfo.awMasterSyncUnitOut[2]));
        }
        ...
        {
            EcLogMsg(EC_LOG_LEVEL_INFO, (pEcLogContext, EC_LOG_LEVEL_INFO, "PD OUT 4 Byte.Bit Offset: %d.%d   Size: %d Bits, MSU %2d\n", oCfgSlaveInfo.dwPdOffsOut4 / 8, oCfgSlaveInfo.dwPdOffsOut4 % 8, oCfgSlaveInfo.dwPdSizeOut4, oCfgSlaveInfo.awMasterSyncUnitOut[3]));
        }
#if (defined NO_OS)
        ((CAtEmLogging*)pEcLogParms->pLogContext)->ProcessAllMsgs();
#endif
    ...
    case ecvendor_beckhoff:
        {
         ...
         /* case ecprodcode_beck_AX2000_B120:   pRet  = "AX2000 B120"; break; */
            ...
            case ecprodcode_beck_BK1250:        pRet  = "BK1250"; break;
         ...
         /* case ecprodcode_beck_EL1014_0010:   pRet  = "EL1014 0010"; break; */
            ...
            case ecprodcode_beck_EL1809:        pRet  = "EL1809"; break;
         ...
         /* case ecprodcode_beck_EL3142_0010:   pRet  = "EL3142 0010"; break; */
            ...
            case ecprodcode_beck_EL4004:        pRet  = "EL4004"; break;
 ...
 */
const EC_T_CHAR* ESCTypeText(EC_T_BYTE byESCType /**< [in] ESC Type (ESC Ado 0x00) */,
                             EC_T_BOOL bLong     /**< [in] true: long text version, false : short text version */)
{
    switch (byESCType)
    {
    case ESCTYPE_BKHF_ELOLD:            return bLong ? "Beckhoff ELs (Old)"       : "ELs"             ;
    case ESCTYPE_ESC10 | ESCTYPE_ESC20: return bLong ? "Beckhoff FPGA ESC 10/20"  : "ESC 10/20"       ;
    case ESCTYPE_IPCORE:                return bLong ? "IPCORE"                   : "IPCORE"          ;
    case ESCTYPE_ET1100:                return bLong ? "Beckhoff ET1100"          : "ET1100"          ;
    case ESCTYPE_ET1200:                return bLong ? "Beckhoff ET1200"          : "ET1200"          ;
    case ESCTYPE_NETX100_500:           return bLong ? "Hilscher NetX 100/500"    : "NetX 500"        ;
    case ESCTYPE_NETX50:                return bLong ? "Hilscher NetX 50"         : "NetX 50"         ;
    case ESCTYPE_NETX5:                 return bLong ? "Hilscher NetX 5"          : "NetX 5"          ;
    case ESCTYPE_NETX51_52:             return bLong ? "Hilscher NetX 51/52"      : "NetX 51/52"      ;
    case ESCTYPE_NETX90:                return bLong ? "Hilscher NetX 90"         : "NetX 90"         ;
    case ESCTYPE_TI_SITARA:             return bLong ? "Texas Instruments Sitara" : "TI Sitara"       ;
    case ESCTYPE_TI_C2000:              return bLong ? "Texas Instruments C2000"  : "TI Sitara C2000" ;
    case ESCTYPE_INFINEON:              return bLong ? "Infineon"                 : "Infineon"        ;
    case ESCTYPE_RENESAS:               return bLong ? "Renesas"                  : "Renesas"         ;
    case ESCTYPE_INNOVASIC:             return bLong ? "Innovasic"                : "Innovasic"       ;
    case ESCTYPE_HMS:                   return bLong ? "HMS"                      : "HMS"             ;
    case ESCTYPE_MICROCHIP:             return bLong ? "Microchip"                : "Microchip"       ;
    case ESCTYPE_TRINAMIC:              return bLong ? "Trinamic"                 : "Trinamic"        ;
    default:                            return bLong ? "Unknown Slave Controller" : "Unknown"         ;
    }
}
