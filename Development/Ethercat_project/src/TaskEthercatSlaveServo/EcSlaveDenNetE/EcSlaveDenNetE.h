...
{
public:
	EcSlaveDenNetE(uint16_t taskId, const std::string &taskName, const std::string &taskPath, uint16_t slaveAddr, const std::string &slaveName);
...
private:
	...
	bool m_tiLimitSwitchPressed = false;
	bool m_tiClutchButtonPressed = false;
	double m_targetPosition_temp = 0;
};
