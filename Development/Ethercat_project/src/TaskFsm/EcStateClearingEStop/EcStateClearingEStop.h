#ifndef EC_STATE_CLEARING_E_STOP_H
#define EC_STATE_CLEARING_E_STOP_H

#include "EcTaskStateBase.h"
#include "SubroutineBase.h"

class EcStateClearingEStop : public EcTaskStateBase
{
public:
    EcStateClearingEStop(uint32_t taskId ,const std::string& taskName, const std::string &taskPath);
    ~EcStateClearingEStop();
    virtual uint32_t addSubroutine() override;
};

namespace EcStateClearingEStopNs
{
...
#endif // EC_STATE_CLEARING_E_STOP_H
