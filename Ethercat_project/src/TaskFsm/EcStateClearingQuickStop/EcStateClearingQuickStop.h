#ifndef EC_STATE_CLEARING_QUICK_STOP_H
#define EC_STATE_CLEARING_QUICK_STOP_H

#include "EcTaskStateBase.h"
#include "SubroutineBase.h"

class EcStateClearingQuickStop : public EcTaskStateBase
{
public:
    EcStateClearingQuickStop(uint32_t taskId ,const std::string& taskName, const std::string &taskPath);
    ~EcStateClearingQuickStop();
    virtual uint32_t addSubroutine() override;
};

namespace EcStateClearingQuickStopNs
{
...
#endif // EC_STATE_CLEARING_QUICK_STOP_H
